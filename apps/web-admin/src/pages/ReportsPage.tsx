...
const REPORTS: ReportDef[] = [
  ...
  {
    type: 'pending-prep-libre',
    label: 'Pendientes libres',
    description: 'Paquetes importados sin preparar.',
    group: 'Preparación pendientes',
    dateField: 'fecha creación',
  },
  {
    type: 'pending-prep-empacado',
    label: 'Pendientes empacados',
    description: 'Listos para bandeja de llamadas.',
    group: 'Preparación pendientes',
    dateField: 'fecha actualización',
  },
  {
    type: 'pending-prep-rechazado',
    label: 'Pendientes rechazados',
    description: 'Rechazados en preparación con observación.',
    group: 'Preparación pendientes',
    dateField: 'fecha actualización',
  },
  {
    type: 'pending-prep-dispensacion',
    label: 'Resumen por dispensación',
    description: 'Cantidad de pendientes por NroDispensacion (libre/empacado/rechazado).',
    group: 'Preparación pendientes',
  },
  {
    type: 'pending-prep-movements',
    label: 'Movimientos de preparación',
    description: 'Importación, empacado, rechazo y asignación a llamadas con usuario y fecha.',
    group: 'Preparación pendientes',
    dateField: 'fecha',
  },
  {
