...
export interface DashboardStats {
  ...
  callManagementStats?: {
    total: number;
    byResult: Array<{ result: string | null; count: number }>;
    operators: Array<{ operatorId: string; name: string; total: number; confirmed: number; effectiveness: number }>;
  };
  operational?: {
    pendingCall: number;
...
export interface SocketEvents {
  ...
  'incident.created': { id: string; deliveryId: string; type: IncidentType };
}
